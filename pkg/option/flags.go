...
func AddFlags(flags *pflag.FlagSet) {
	...
	flags.String(KeyServerAddress, "", "gRPC server address (e.g. 'localhost:54321' or 'unix:///var/run/tetragon/tetragon.sock'). An empty address disables the gRPC server")
