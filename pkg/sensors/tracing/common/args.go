...
// HasCurrentTaskSource checks if the argument source is "current_task"
func HasCurrentTaskSource(arg *v1alpha1.KProbeArg) bool {
	return arg.Source == "current_task"
}

// HasPtRegsSource checks if the argument source is "pt_regs"
func HasPtRegsSource(arg *v1alpha1.KProbeArg) bool {
	return arg.Source == "pt_regs"
}

// GetMetaValue extracts metadata value from KProbeArg
// meta value format:
// bits
//
//	0-3 : SizeArgIndex
...
//	  6 : CurrentTask
//	  7 : PtRegs
func GetMetaValue(arg *v1alpha1.KProbeArg, hasCurrentTask, hasPtRegs bool) (int, error) {
	var meta int
...
// GetTracepointMetaValue is a temporary helper to find meta values while tracepoint
...
// GetArg reads and parses an argument from the bytes reader based on the argPrinter configuration
...
// ReadArgBytes reads byte arguments from the reader
